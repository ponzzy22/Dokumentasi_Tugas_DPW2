        ...
        <div class="row">
            <div class="col-md-12 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('produk/filter') }}" method="post">
                            ...
                            <button class="btn btn-primary" class="btn btn-dark float-right"><i
                ...
                <div class="card">
                    <div class="card-header">
                        DATA PRODUK
                        <a href="{{ url('produk/create') }}" class="btn btn-success float-right"><i
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <form action="{{ url('produk', $produk->id) }}" method="post"
                                                        class="form-inline" onsubmit="return confirm('Yakin kan aku')">
                                                        @csrf
                                                        @method("delete")
